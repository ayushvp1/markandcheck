export default function Industries() {
  const industries = [
    ...
    },
    {
      ...
      icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z" /></svg>
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Mark & Check delivers integrated advisory outsourcing, audit, tax & consulting services to help clients succeed professionally and personally grounded in 
            public accounting. Our professional services allow us to serve clients more competitively & offer our people diverse career opportunities.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {industries.map((industry, index) => (
            <div
              key={index}
              className="flex items-center p-3 sm:p-4 rounded-lg transition-colors duration-200 group cursor-pointer bg-[#C4B5A0]/60 hover:bg-[#5C4A3A]"
            >
              <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center mr-3 sm:mr-4 bg-white group-hover:bg-[#E8DCC8] transition-colors text-[#8B7355] group-hover:text-[#5C4A3A]">
                {industry.icon}
              </div>

              <div className="flex-1">
                <h3 className="text-sm font-semibold text-gray-900 transition-colors group-hover:text-white">
                  {industry.name}
                </h3>
              </div>
            </div>
        ...
        <div className="text-center mt-12">
          ...
          <a
            href="#contact"
            className="inline-block px-8 py-3 rounded-lg font-medium transition-colors duration-200 bg-[#8B7355] text-white hover:bg-[#5C4A3A]"
          >
            Contact Us Today
          </a>
        </div>
