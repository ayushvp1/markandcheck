...
export default async function LatestUpdatesPreview() {
  await dbConnect();
  const items = await News.find().sort({ publishDate: -1, createdAt: -1 }).limit(3).lean();
  ...
  return (
    <section id="blogs" className="py-16 bg-gray-50">
      <div className="max-w-6xl mx-auto px-8">
        ...
        {/* View All Articles Button for home page */}
