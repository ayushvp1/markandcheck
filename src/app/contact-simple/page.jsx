      ...
      <form className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-brown focus:border-transparent transition-colors resize-vertical"
            placeholder="Share any details about your query or the services you're interested in"
          />
        </div>
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="py-16 bg-[#F5F1E8]">
        <div className="max-w-6xl mx-auto px-8 text-center">
          ...
          >
            Share your details and we'll get back to you with the right solution for your business.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          {/* Contact Information Sidebar (same as contact page) */}
